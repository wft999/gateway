...
void *SingleValueCreateContext(__attribute__((unused)) bool reverse) {
    SingleValueContext *context = (SingleValueContext *)RedisModule_Alloc(sizeof(SingleValueContext));
    context->value = 0;
...
void *AvgCreateContext(__attribute__((unused)) bool reverse) {
    AvgContext *context = (AvgContext *)RedisModule_Alloc(sizeof(AvgContext));
...
void *TwaCreateContext(bool reverse) {
    TwaContext *context = (TwaContext *)RedisModule_Alloc(sizeof(TwaContext));
...
void *StdCreateContext(__attribute__((unused)) bool reverse) {
    StdContext *context = (StdContext *)RedisModule_Alloc(sizeof(StdContext));
    context->cnt = 0;
    context->sum = 0;
    context->sum_2 = 0;
    return context;
...
void *MaxMinCreateContext(__attribute__((unused)) bool reverse) {
    MaxMinContext *context = (MaxMinContext *)RedisModule_Alloc(sizeof(MaxMinContext));
